...
abstract class GraphQLCommonGrammarDefinition extends GrammarBaseDefinition {
  ...
  Parser queryDocument() {
    return (ref(operationDefinition) | ref(fragmentDefinition) | ref(typeSystemDefinition)).plus();
  }

  Parser schemaDocument() {
  ...
  Parser selectionSet() {
    return ref(OPEN_BRACE) & ref(selection).separatedBy(ref(separator)) & ref(CLOSE_BRACE);
  }
